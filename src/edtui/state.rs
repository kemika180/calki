...
use crate::edtui::clipboard::{Clipboard, ClipboardTrait};
...
mod tests {
    ...
    fn test_single_line_mode_blocks_line_break() {
        use crate::edtui::actions::LineBreak;
    ...
    fn test_single_line_mode_blocks_insert_newline_char() {
        use crate::edtui::actions::InsertChar;
